...
<template>
  <div v-if="open" class="fixed inset-0 z-[60] flex items-center justify-center p-4">
    ...
    <div class="relative responsive-modal-panel bg-bg-card w-full max-w-[680px] max-h-[88vh] rounded-[20px] shadow-2xl overflow-hidden flex flex-col border border-outline-variant/30" role="dialog" aria-modal="true" aria-labelledby="network-check-title">
      <!-- Header -->
